...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.DtoWikiAskReq();
  });
  ...
  describe('DtoWikiAskReq', function() {
    it('should create an instance of DtoWikiAskReq', function() {
      // uncomment below and update the code to test DtoWikiAskReq
      //var instance = new TxingAiApi.DtoWikiAskReq();
      //expect(instance).to.be.a(TxingAiApi.DtoWikiAskReq);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.DtoUpdateAboutMeReasonReq();
  });
  ...
  describe('DtoUpdateAboutMeReasonReq', function() {
    it('should create an instance of DtoUpdateAboutMeReasonReq', function() {
      // uncomment below and update the code to test DtoUpdateAboutMeReasonReq
      //var instance = new TxingAiApi.DtoUpdateAboutMeReasonReq();
      //expect(instance).to.be.a(TxingAiApi.DtoUpdateAboutMeReasonReq);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.VoAboutMeReasonVO();
  });
  ...
  describe('VoAboutMeReasonVO', function() {
    it('should create an instance of VoAboutMeReasonVO', function() {
      // uncomment below and update the code to test VoAboutMeReasonVO
      //var instance = new TxingAiApi.VoAboutMeReasonVO();
      //expect(instance).to.be.a(TxingAiApi.VoAboutMeReasonVO);
    });

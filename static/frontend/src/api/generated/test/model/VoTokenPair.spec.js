...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.VoTokenPair();
  });
  ...
  describe('VoTokenPair', function() {
    it('should create an instance of VoTokenPair', function() {
      // uncomment below and update the code to test VoTokenPair
      //var instance = new TxingAiApi.VoTokenPair();
      //expect(instance).to.be.a(TxingAiApi.VoTokenPair);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.DtoUpdatePasswordReq();
  });
  ...
  describe('DtoUpdatePasswordReq', function() {
    it('should create an instance of DtoUpdatePasswordReq', function() {
      // uncomment below and update the code to test DtoUpdatePasswordReq
      //var instance = new TxingAiApi.DtoUpdatePasswordReq();
      //expect(instance).to.be.a(TxingAiApi.DtoUpdatePasswordReq);
    });

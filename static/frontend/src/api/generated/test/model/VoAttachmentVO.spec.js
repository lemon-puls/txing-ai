...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.VoAttachmentVO();
  });
  ...
  describe('VoAttachmentVO', function() {
    it('should create an instance of VoAttachmentVO', function() {
      // uncomment below and update the code to test VoAttachmentVO
      //var instance = new TxingAiApi.VoAttachmentVO();
      //expect(instance).to.be.a(TxingAiApi.VoAttachmentVO);
    });

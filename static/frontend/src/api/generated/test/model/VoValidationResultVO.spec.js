...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.VoValidationResultVO();
  });
  ...
  describe('VoValidationResultVO', function() {
    it('should create an instance of VoValidationResultVO', function() {
      // uncomment below and update the code to test VoValidationResultVO
      //var instance = new TxingAiApi.VoValidationResultVO();
      //expect(instance).to.be.a(TxingAiApi.VoValidationResultVO);
    });

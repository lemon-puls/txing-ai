...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.GlobalModelMapping();
  });
  ...
  describe('GlobalModelMapping', function() {
    it('should create an instance of GlobalModelMapping', function() {
      // uncomment below and update the code to test GlobalModelMapping
      //var instance = new TxingAiApi.GlobalModelMapping();
      //expect(instance).to.be.a(TxingAiApi.GlobalModelMapping);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.DtoUpdateChannelReq();
  });
  ...
  describe('DtoUpdateChannelReq', function() {
    it('should create an instance of DtoUpdateChannelReq', function() {
      // uncomment below and update the code to test DtoUpdateChannelReq
      //var instance = new TxingAiApi.DtoUpdateChannelReq();
      //expect(instance).to.be.a(TxingAiApi.DtoUpdateChannelReq);
    });

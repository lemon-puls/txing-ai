...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TxingAiApi.DtoWikiUpdateDraftReq();
  });
  ...
  describe('DtoWikiUpdateDraftReq', function() {
    it('should create an instance of DtoWikiUpdateDraftReq', function() {
      // uncomment below and update the code to test DtoWikiUpdateDraftReq
      //var instance = new TxingAiApi.DtoWikiUpdateDraftReq();
      //expect(instance).to.be.a(TxingAiApi.DtoWikiUpdateDraftReq);
    });
